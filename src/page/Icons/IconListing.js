...
import IconDetailPopup from "../../component/IconDetailPopup";
...
function IconListing() {
    ...
    return ( 
        <>
        <div>
            <div className="pointer-events-auto relative bg-white shadow-[0_1px_3px_rgba(15,23,42,0.08)] sticky top-0 -mb-10 overflow-hidden sm:-mb-11">
            ...
            <div className="flex pt-11">
                    { filterSidebar ? 
                    <div className="w-1/5 p-4 overflow-y-auto overflow-y-scroll h-screen transition-all duration-700 transition-transform bg-slate-100">
        ...
        { showPopup ? <IconDetailPopup show={showPopup} onClose={togglePopup} popupDetails={popupData} sizeValue={sizeValue} colorValue={colorValue}/> : ''}
        </>
    );
}
